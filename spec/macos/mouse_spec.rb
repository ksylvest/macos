...
RSpec.describe MacOS::Mouse do
  ...
  describe "#left_mouse_down" do
    subject(:left_mouse_down) { mouse.left_mouse_down(x:, y:) }
  ...
  describe "#left_mouse_up" do
    subject(:left_mouse_up) { mouse.left_mouse_up(x:, y:) }
  ...
  describe "#left_mouse_click" do
    subject(:left_mouse_click) { mouse.left_mouse_click(x:, y:) }

    it "uses 'left_mouse_down' and 'left_mouse_up'" do
      allow(mouse).to receive(:left_mouse_down)
      allow(mouse).to receive(:left_mouse_up)
      left_mouse_click
      expect(mouse).to have_received(:left_mouse_down).with(x:, y:)
      expect(mouse).to have_received(:left_mouse_up).with(x:, y:)
    end
  end

  describe "#right_mouse_down" do
    subject(:right_mouse_down) { mouse.right_mouse_down(x:, y:) }
  ...
  describe "#right_mouse_up" do
    subject(:right_mouse_up) { mouse.right_mouse_up(x:, y:) }
  ...
  describe "#right_mouse_click" do
    subject(:right_mouse_click) { mouse.right_mouse_click(x:, y:) }
    ...
    it "uses 'right_mouse_down' and 'right_mouse_up'" do
      ...
      right_mouse_click
      expect(mouse).to have_received(:right_mouse_down).with(x:, y:)
      expect(mouse).to have_received(:right_mouse_up).with(x:, y:)
    end
  end

  describe "#middle_mouse_down" do
    subject(:middle_mouse_down) { mouse.middle_mouse_down(x:, y:) }
  ...
  describe "#middle_mouse_up" do
    subject(:middle_mouse_up) { mouse.middle_mouse_up(x:, y:) }
  ...
  describe "#middle_mouse_click" do
    subject(:middle_mouse_click) { mouse.middle_mouse_click(x:, y:) }
    ...
    it "uses 'middle_mouse_down' and 'middle_mouse_up'" do
      ...
      middle_mouse_click
      expect(mouse).to have_received(:middle_mouse_down).with(x:, y:)
      expect(mouse).to have_received(:middle_mouse_up).with(x:, y:)
    end
  end
end
